                ...
                <form method="post" class="base_form">
                    ...
                    <div>
                        <div class="infospaceAddContent clearfix">
                            ...
                            <div><input type="text" name="data[title]" placeholder=""></div>
                        </div>
                        <div class="infospaceAddContent clearfix">
                        ...
                        <div class="infospaceAddContent clearfix">
                            ...
                            <div><input type="text" name= "data[total]" placeholder="单位元">元</div>
                        </div>
                        <div class="infospaceAddContent clearfix">
                            <div class="infospaceAddLeft"><span>*</span>单标限制：</div>
                            <div><input type="text" name = "data[limit]" placeholder="比如 1000元">元</div>
                        </div>
                        <div class="infospaceAddContent clearfix">
                            <div class="infospaceAddLeft"><span>*</span>起诉金额：</div>
                            <div><input type="text" name = "data[sued]" placeholder="比如 200元">元</div>
                        </div>
                        <div class="infospaceAddContent clearfix">
                        ...
                        <div class="infospaceAddContent clearfix">
                            ...
                            <div><input type="text" name = "data[ratio]" placeholder="浮点数比如12.91"></div>
                        </div>
                        <div class="infospaceAddContent clearfix">
                            <div class="infospaceAddLeft"><span>*</span>本站年转化率：</div>
                            <div><input type="text" name = "data[mratio]" placeholder="本站增加的转化率"></div>
                        </div>
                        <div class="infospaceAddContent clearfix">
                            <div class="infospaceAddLeft"><span>*</span>期限：</div>
                            <div><input type="text" name = "data[term]" placeholder="比如7天/3个月"></div>
                        </div>
                        <div class="infospaceAddContent clearfix">
                            <div class="infospaceAddLeft"><span>*</span>保障方式：</div>
                            <div><input type="text" name = "data[ensure]" placeholder="比如 第三方担保"></div>
                        </div>
                        <div class="infospaceAddContent clearfix">
                            <div class="infospaceAddLeft"><span>*</span>还款方式：</div>
                            <div><input type="text" name = "data[repay]" placeholder="比如 付本还息"></div>
                        </div>
                        <div class="infospaceAddContent clearfix">
                            <div class="infospaceAddLeft"><span>*</span>计息凡是：</div>
                            <div><input type="text" name = "data[accrual]" placeholder="比如 (T+0到账\T+1到账)"></div>
                        </div>
                    </div>
                    <div class="w928">
                        <div class="button">
