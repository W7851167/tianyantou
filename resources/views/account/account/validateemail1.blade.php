<div class="control-group">
    ...
    <form class="form-group" data-toggle="ajaxForm" method="post" action="{!! config('app.account_url') !!}/safe/validateEmail.html" data-refresh-url="#email-panel" data-callback="autoResize">
        <div class="control-group">
            ...
            <a class="action btn-captcha btn-l" data-toggle="verifyEmail" data-url="{!! config('app.account_url') !!}/safe/validateEmail.html" data-email="#newemail" data-action="changeEmail">发送邮箱验证码</a>
