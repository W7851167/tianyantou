<div>
    ...
    </ul>        <form class="form-group" data-toggle="ajaxForm" method="post" action="https://account.touzhijia.com/safe/validateEmail.html"
                       data-refresh-url="#email-panel" data-callback ="autoResize">
        <div class="control-group">
            <label>邮箱：</label>
            <input id="newemail" type="text" name="email" class="input-style"/>
            <a class="action btn-captcha btn-l" data-toggle="verifyEmail" data-url="https://account.touzhijia.com/safe/validateEmail.html" data-email="#newemail" data-action="authEmail">发送邮箱验证码</a>
