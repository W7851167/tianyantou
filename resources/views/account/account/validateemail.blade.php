<div>
    ...
    <form class="form-group" data-toggle="ajaxForm" method="post" action="https://account.tianyantou.com/safe/validateEmail.html"
        ...
        <div class="control-group">
            ...
            <a class="action btn-captcha btn-l" data-toggle="verifyEmail" data-url="https://account.tianyantou.com/safe/validateEmail.html" data-email="#newemail" data-action="authEmail">发送邮箱验证码</a>
