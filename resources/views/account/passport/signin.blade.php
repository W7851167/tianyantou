        ...
        <div id="loginpage">
          ...
          <span class="is-check checked">
            ...
            记住用户名
                                    ...
                                    <p></p>
                                    <input type="hidden" name="url" value="https://www.touzhijia.com/" />
                                    <div class="login-other-box">
                                        <span>用第三方账号直接登陆</span>
                                        <div class="partner-box">
                                            <a class="partner" href="{!! config('app.account_url') !!}/thirdparty/login/qq.html"><img src="{!! config('app.static_url') !!}/images/user/reg-qq.png?ver={!! time() !!}" alt="腾讯QQ"></a>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="code-btn">
                                ...
                                <span class="msg"><img src="{!! config('app.static_url') !!}/images/user/1.png?ver={!! time() !!}" height="28px" />使用<b>微信</b>快捷登录→</span>
                            </div>
...
@stop
@section('script')
<script type="text/javascript" src="{!! config('app.static_url') !!}/js/lib/jquery.form.min.js?ver={!! time() !!}"></script>
<script type="text/javascript" src="{!! config('app.static_url') !!}/js/plugins/ucenter.js?ver={!! time() !!}"></script>
<script type="text/javascript" src="{!! config('app.static_url') !!}/js/plugins/pagination.js?ver={!! time() !!}"></script>
<script type="text/javascript" src="{!! config('app.static_url') !!}/js/plugins/actions.js?ver={!! time() !!}"></script>
<script type="text/javascript" src="{!! config('app.static_url') !!}/js/plugins/form.js?ver={!! time() !!}"></script>
<script type="text/javascript" src="{!! config('app.static_url') !!}/js/base64encode.js?ver={!! time() !!}"></script>
<script type="text/javascript" src="{!! config('app.static_url') !!}/js/plugins/login.js?ver={!! time() !!}"></script>
<script type="text/javascript" src="{!! config('app.static_url') !!}/js/plugins/wxLogin.js?ver={!! time() !!}"></script>
@stop
