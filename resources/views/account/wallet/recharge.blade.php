...
<div style='BORDER: 1px solid #DCE6F4; MARGIN-TOP: 20px; MARGIN-BOTTOM: 20px; MARGIN-LEFT: 5px; MARGIN-RIGHT: 5px; PADDING: 5px; BACKGROUND-COLOR: #eef8ff;line-height:180%; COLOR: #000000; font-family: Arial; font-size: 8pt; width=100%; FILTER: progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr="#FFFFFFFF", EndColorStr="#F2F5FAFF");'>
    ...
    <b>Address:</b> <a class="info" href="https://account.touzhijia.com/wallet/recharge.html">https://account.touzhijia.com/wallet/recharge.html</a><br>
    <b>Title:</b> 天眼投 - 个人中心 &nbsp;&bull;&nbsp; <b>Size:</b> 66884<br></div>
<!-- /Copyright � 2005. Spidersoft Ltd -->
...
<div id="head">
    ...
    <div id="head-top">
        <div id="head-top-main">
            ...
            <div class="top-menu">
                <div class="my-menu">
                    <a id="my-menu" href="https://account.touzhijia.com/">我的天眼投<i></i></a>
                    <div class="menu-box">
                        <div class="user-img">
                        ...
                        <div class="menu-list">
                            <ul>
                                <li><a href="https://account.touzhijia.com/wallet/recharge.html"><i class="iconfont">&#xe63f;</i>账户充值</a></li>
                                <li><a href="https://account.touzhijia.com/debt.html"><i class="iconfont">&#xe641;</i>理财管理</a></li>
                                <li><a href="https://account.touzhijia.com/wallet/book.html"><i class="iconfont">&#xe640;</i>资金流水</a></li>
                                <li><a href="https://account.touzhijia.com/safe.html"><i class="iconfont">&#xe63e;</i>安全中心</a></li>
                            </ul>
...
<div class="main-float-nav" id="main-float-navo" closebz="0">
    ...
    <div class="figure">
        ...
        <a href="https://www.touzhijia.com/mascot.html" class="peoplelink" target="_blank" title="天眼投吉祥物"></a>
    ...
    <ul>
        <li>
            ...
            <div class="hovercon">
                <p class="tap-show phonep"><a href="https://www.touzhijia.com/about/notice.html">天眼投公告</a></p>
            </div>
        </li>
        <li>
