...
<head>
    ...
    <title>月度报告 - 关于我们 - 投之家</title>
    <meta name="keywords" content="月度报告，投之家月度报告，投之家理财投资平台">
...
<div id="aboutpage" class="wrap">
    <div class="container">
        <ul class="main-nav">
            ...
            <li class="nav-location">月度报告</li></ul>      <div class="r-side-menu nav-follow">
            <h2>关于我们</h2>
            <ul class="first-menu">
                <li ><a href="https://www.touzhijia.com/about/company.html"><i class="iconfont" >&#xe61f;</i>公司介绍</a></li>
                <li class="active"><a href="https://www.touzhijia.com/about/monthly.html"><i class="iconfont" >&#xe62c;</i>月度报告</a></li>
...
<script type="text/javascript">
    (function(){
        ...
        var aBtn = $('.monthly').find('a');
        aBtn.hover(function(){
            aBtn.css('opacity',0.5);
            $(this).css('opacity',1);
        },function(){
            aBtn.css('opacity',1);
        });
