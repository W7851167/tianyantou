...
<div class="plat-box">
    ...
    <div class="plat-main">
        ...
        <div class="plat-info" style="position: relative;">
            ...
            <span style="width: 300px;margin-left: -15px;">天眼加化率：<em>@if($cv->min_myield == $cv->max_myield){!! $cv->max_myield or 0.00 !!}%@else{!! $cv->min_yield or 0.00 !!}%-{!! $cv->max_yield or 0.00 !!}%@endif</em></span>
