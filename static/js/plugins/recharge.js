 $(function() {
    var recharge = {
      ...
      tipBox: function (responseText, status) {
        ...
        var tips = {
          202:'充值订单正在处理中，你可以查看<a href="' +　DOMAIN.account + '/wallet/rechargelist.html">充值记录</a>跟踪订单状态',
          200:'恭喜您！充值成功'
        };
        var boxConfig = {
            title:'充值通知',
            ...
            success: function(layero, index) {
              layero.find('.layui-layer-btn0').attr('href',DOMAIN.account + '/wallet/rechargelist.html');
