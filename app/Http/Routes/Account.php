...
//    Route::get('coupon/index.html', ['as' => 'coupon', 'uses' => 'CouponController@index']);
    ...
    Route::get('message/readAll.html',['as'=>'message.readAll','uses'=>'MessageController@readAll']);
    Route::get('message/deleteAll.html',['as'=>'message.deleteAll','uses'=>'MessageController@deleteAll']);
    //我的积分
